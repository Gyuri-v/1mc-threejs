...
export default function example() {
  ...
  scene.background = new THREE.Color("#ffffff");
    ...
    roughness: 0.3,
    metalness: 0.3,
    normalMap: normalColorTex, // 입체감이 살아남
    roughnessMap: roughnessColorTex, // 거칠기의 디테일이 살아남 - 빛이 다르게 들어가고
    aoMap: ambientColorTex, // 그림자부분을 조금 어둡게 해줌
    aoMapIntensity: 5, // aoMap 강조 설정
	});
